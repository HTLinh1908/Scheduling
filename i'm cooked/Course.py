class Course:
    def __init__(self, code, name, major, level, course_length, capacity, instructor, is_restricted, time_slots=None):
        ...
        self.name = name
        # the course name, E.g. Data Structures, Calculus
        ...
        # the type of the course: 0 for 1.5h x 2, 1 for 3h courses
